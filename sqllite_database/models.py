...
rus_list = {'signals': ['№', 'Тип сигнала', 'Шкаф', 'Идентификатор', 'Наименование', 'Схема', 'Клеммник', 'Контакт', 'Корзина', 'Модуль', 'Канал'],
            ...
            'pi': ['', '', '', '1 - пламени, 2 - тепловой, 3 - дымовой, 4 - АПУ, 5 - тепловой аналоговый'], 
                }
...
class VV(BaseModel):
    Переменная = CharField(null = True)
    Название = CharField(null = True)
    Высоковольтный_выключатель_включен = CharField(null = True)
    Высоковольтный_выключатель_отключен = CharField(null = True)
    Pic = CharField(null = True)
...
class PI(BaseModel):
    ...
    Идентификатор = CharField(null = True)
    Название = CharField(null = True)
    Тип_ПИ = CharField(null = True)
    Пожар_0 = CharField(null = True)
    Внимание_1 = CharField(null = True)
    Неисправность_1_загрязнение_стекла_обрыв_2 = CharField(null = True)
    Неисправность_2_неисправность_КЗ_3 = CharField(null = True)
    Есть_связь_4 = CharField(null = True)
    Неисправность_генератора_частоты_5 = CharField(null = True)
    Ошибка_загрузки_параметров_6 = CharField(null = True)
    Ошибка_связи_с_модулем_ИПП_7 = CharField(null = True)
    Неисправность_напряжения_питания_8 = CharField(null = True)
    Загрязнение_оптики_9 = CharField(null = True)
    Неисправность_ИК_канала_10 = CharField(null = True)
    Неисправность_УФ_канала_11 = CharField(null = True)
    Загрузка_12 = CharField(null = True)
    Тест_13 = CharField(null = True)
    Резерв_14 = CharField(null = True)
    Сброс_ссылка = CharField(null = True)
    Сброс_запроса = CharField(null = True)
    Сквозной_номер_шлейфа_для_интерфейсных = CharField(null = True)
    Место_установки = CharField(null = True)
    Pic = CharField(null = True)
    Норма = CharField(null = True)
