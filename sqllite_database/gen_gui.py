...
class Widget(QWidget):
    ...
    def check_omx_ai(self, checked):
        if checked: self.list_gen_vu.append('AI_omx')
        else      : self.list_gen_vu.remove('AI_omx')
    def check_omx_di(self, checked):
        if checked: self.list_gen_vu.append('DI_omx')
        else      : self.list_gen_vu.remove('DI_omx')
    def check_omx_vs(self, checked):
        if checked: self.list_gen_vu.append('VS_omx')
        else      : self.list_gen_vu.remove('VS_omx')
    def check_omx_zd(self, checked):
        if checked: self.list_gen_vu.append('ZD_omx')
        else      : self.list_gen_vu.remove('ZD_omx')
    def check_omx_na(self, checked):
        if checked: self.list_gen_vu.append('NA_omx')
        else      : self.list_gen_vu.remove('NA_omx')
    def check_omx_pic(self, checked):
        if checked: self.list_gen_vu.append('PIC_omx')
        else      : self.list_gen_vu.remove('PIC_omx')
    # Button confirm
    def omx_list(self):
