...
class Widget(QWidget):
    def __init__(self):
        ...
        readtablbutt.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        self.select_uso.setStyleSheet('border: 1px solid')
        ...
        self.select_row.setStyleSheet('border: 1px solid #6f7370; border: 1px solid')
        ...
        b_io_basket.setStyleSheet("background: #bfd6bf; border: 1px solid ")
        ...
        b_clear_tabl.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_uso_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_uso.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_ai_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_ai.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_ao_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_ao.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_di_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_di.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_do_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_do.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_uts_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_uts.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_vv_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_vv.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_utstm_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_utstm.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_ktpr_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_ktpr.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_ktpra_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_ktpra.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_ktprs_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_ktprs.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_gmpna_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_gmpna.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        self.l_count_NA.setStyleSheet('border: 1px solid #6f7370; border: 1px solid')
        self.l_count_NA.move(b_width_two + 540, l_height)
        self.l_count_NA.resize(80,15)
        b_umpna_basket = QPushButton('Заполнить', tab_3)
        b_umpna_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_umpna.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_tm_umpna_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_tm_umpna.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_zd_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        ** Исправность_цепей_закрытия, Открыть, Закрыть, Остановить, Открытие_остановить, Закрытие_остановить;
        ...
        b_clear_zd.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_tm_zd_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_tm_zd.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_vs_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        ** МП, Напряжение, Включить, Отключить, Внешняя авария, Исправность цепей открытия, Давление(может некорректно заполниться!);
        ...
        b_clear_vs.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_tm_vs_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_tm_vs.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_vsgrp_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_vsgrp.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_tm_vsgrp_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_tm_vsgrp.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_pi_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        ** Идентификатор, Название, Тип ПИ, Пожар, Внимание, Загрязнение стекла, Неисправность/КЗ, Сброс ссылка;
        ...
        b_clear_pi.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_tm_pz_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_tm_pz.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        b_ktprp_basket.setStyleSheet("background: #bfd6bf; border: 1px solid")
        ...
        b_clear_ktprp.setStyleSheet("background: #bbbabf; border: 1px solid")
        ...
        # Подтверждение
        b_export_list = QPushButton('Генерировать скрипты\nдля базы данных', tab_4)
        b_export_list.setStyleSheet("background: #bbbabf; border: 1px solid")
