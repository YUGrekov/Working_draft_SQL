...
class Widget(QWidget):
    def __init__(self):
        ...
        ** Идентификатор, Название, Тип ПИ, Пожар, Внимание, Загрязнение стекла, Неисправность/КЗ, Сброс ссылка;
        ...
        self.q_check_other.move(160, 35) 
        ...
        self.q_check_ktpra.move(230, 82) 
        ...
        self.q_check_ktprs.move(230, 98) 
        ...
        self.q_check_gmpna.move(230, 114) 
